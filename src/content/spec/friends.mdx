...
export const site = {
  name: "昔涟",
  desc: "站点介绍等待补充。",
  url: "https://cyrene-blog.vercel.app",
      ...
      <div class="p-5 sm:p-6 flex flex-col flex-1">
        ...
        <div class="flex items-center gap-4 mb-5">
          <div class="relative shrink-0">
            ...
            <div class="absolute -bottom-1 -right-1 w-5 h-5 rounded-full bg-(--primary-surface) flex items-center justify-center shadow">
              <svg class="w-3 h-3 text-(--primary-contrast)" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
            </div>
          </div>
          <div>
    ...
    <div class="rounded-2xl border border-(--line-divider) overflow-hidden flex flex-col">
      <div class="p-5 sm:p-6 flex flex-col flex-1">
        <h3 class="text-lg font-bold mb-5 flex items-center gap-2">
          <span class="w-7 h-7 rounded-lg bg-(--primary-surface)/10 flex items-center justify-center text-(--primary) text-sm">
        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            <div class="flex flex-col items-center">
              <div class="w-7 h-7 rounded-full bg-(--primary-surface) text-(--primary-contrast) text-xs font-bold flex items-center justify-center shrink-0">1</div>
          ...
          <div class="flex gap-3.5">
            <div class="flex flex-col items-center">
              <div class="w-7 h-7 rounded-full bg-(--primary-surface) text-(--primary-contrast) text-xs font-bold flex items-center justify-center shrink-0">2</div>
              <div class="w-0.5 flex-1 bg-(--line-divider) my-1.5"></div>
            </div>
            <div class="pb-4">
              <p class="font-semibold text-sm mb-1">提交方式：<code class="px-1.5 py-0.5 rounded bg-black/5 dark:bg-white/10 text-[0.7rem]">{site.email}</code></p>
          ...
          <div class="flex gap-3.5">
            <div class="flex flex-col items-center">
              <div class="w-7 h-7 rounded-full bg-(--primary-surface) text-(--primary-contrast) text-xs font-bold flex items-center justify-center shrink-0">3</div>
            </div>
            <div>
      ...
      <div class="space-y-3 text-sm text-neutral-600 dark:text-neutral-400">
        {notes.map((item) => (
          <div class="flex items-baseline gap-2.5">
            <span class="w-1.5 h-1.5 rounded-full bg-(--primary-surface) shrink-0 translate-y-[-2px]"></span>
