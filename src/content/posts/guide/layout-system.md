...
description: 了解博客的侧边栏布局、文章列表布局与自适应网格列数。
image: ../images/firefly1.avif
tags: [布局, 博客, 指南]
category: 博客指南
slug: guide/layout-system
---

## 📖 概述

当前博客提供了灵活的布局系统，允许您根据内容需求和个人喜好自定义视觉呈现方式。布局系统主要包括**侧边栏布局**和**文章列表布局**两个维度，它们相互配合，共同决定了页面的整体结构。

本文将介绍当前博客的各种布局模式、它们的特点、使用场景，以及不同布局组合的效果。
...
侧边栏是博客页面的重要组成部分，用于展示导航、分类、标签、统计信息等辅助内容。当前博客支持两种侧边栏布局模式。
...
文章列表是博客首页和归档页的核心内容，当前博客提供两种展示方式，并支持多种网格配置。
...
当前博客的网格模式内置了智能瀑布流布局支持，解决图文混合文章卡片高度不一致导致的空白问题。
...
当前博客允许您自由组合侧边栏和文章列表布局。以下是各种组合的效果说明。
